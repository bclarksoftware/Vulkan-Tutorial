//
// Created by bcware on 5/2/2020.
//

#ifndef VULKANTUTORIAL_SHADERCOMPILER_HPP
#define VULKANTUTORIAL_SHADERCOMPILER_HPP

#endif //VULKANTUTORIAL_SHADERCOMPILER_HPP
...
std::vector<unsigned int> CompileGLSL(const std::string& filename)
{
